...
#OBJECTIVES    
In this module we will examine Discriminant Function Analysis, a pattern-recognition statistical method that characterizes or seperates two or more classes of objects or events. We will go over the different uses of DFAs, work through a basic example by hand, and will end with running an analysis together using actual data and function within packages in R.   
...
**Training data:** Dataset of variables with known groupings that is used to generate a model.
...
+   (iris) or (iris3) [learn about the difference between format here ](https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/iris.html)  
